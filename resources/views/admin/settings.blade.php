...
<form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(400px, 1fr)); gap: 2rem;">
        ...
        <div class="card">
            ...
            <div style="padding-top: 1rem;">
                <div class="form-group">
                    <label class="form-label"><i class="fa-brands fa-facebook" style="color: #1877F2; margin-left: 0.25rem;"></i> فيسبوك</label>
                ...
                <div class="form-group">
                    <label class="form-label"><i class="fa-brands fa-twitter" style="color: #1DA1F2; margin-left: 0.25rem;"></i> تويتر (X)</label>
                ...
                <div class="form-group">
                    <label class="form-label"><i class="fa-solid fa-shield-halved" style="margin-left: 0.25rem;"></i> وضع الصيانة</label>
    ...
    <div style="margin-top: 2rem; display: flex; gap: 1rem; justify-content: flex-end;">
        <button type="submit" class="btn btn-primary" style="padding: 1rem 3rem; display: flex; align-items: center; gap: 0.75rem;">
