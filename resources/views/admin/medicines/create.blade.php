...
<style>
    ...
    .btn-submit:hover { transform: translateY(-2px); box-shadow: 0 10px 15px -3px rgba(59, 130, 246, 0.3); }
</style>
@endpush
...
<div class="admin-container">
    <div class="page-header">
        <h1 class="page-title"><i class="fa-solid fa-pills" style="color:#3b82f6;margin-left:0.5rem"></i> إضافة دواء جديد</h1>
    </div>
        ...
        <form action="{{ route('admin.medicines.store') }}" method="POST">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:1.5rem">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="low_stock_threshold" class="form-control" value="{{ old('low_stock_threshold', 10) }}" min="0" required>
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" name="price" class="form-control" value="{{ old('price') }}" min="0">
            ...
            <div class="form-group" style="display:flex;align-items:center;gap:0.75rem;margin-top:1rem">
                ...
                <input type="checkbox" name="is_active" value="1" id="is_active" {{ old('is_active', true) ? 'checked' : '' }} style="width:20px;height:20px;accent-color:#3b82f6">
            ...
            <button type="submit" class="btn-submit" style="margin-top:2rem">
                <i class="fa-solid fa-save"></i> حفظ الدواء
            </button>
