...
@section('title', 'إنشاء حساب جديد - صحتي')
            ...
            <form method="POST" action="{{ route('register') }}" class="p-8 space-y-6">
                ...
                <div>
                    <label for="name" class="block text-sm font-bold text-slate-700 mb-2">
                        <i class="fas fa-user ml-2 text-blue-600"></i>الاسم الكامل
                    </label>
                ...
                <div>
                    <label for="role" class="block text-sm font-bold text-slate-700 mb-2">
                        <i class="fas fa-user-tag ml-2 text-blue-600"></i>نوع الحساب
                    </label>
                    <select id="role" name="role" required
                        class="w-full px-4 py-3 rounded-lg border-2 border-slate-200 focus:border-blue-500 focus:outline-none transition @error('role') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="password" id="password" name="password" required
                        class="w-full px-4 py-3 rounded-lg border-2 border-slate-200 focus:border-blue-500 focus:outline-none transition @error('password') border-red-500 @enderror"
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm font-bold text-slate-700 mb-2">
                        <i class="fas fa-lock ml-2 text-blue-600"></i>تأكيد كلمة المرور
                    </label>
                ...
                <p class="text-center text-slate-600">
                    لديك حساب بالفعل؟
                    <a href="{{ route('login') }}" class="text-blue-600 font-bold hover:underline">سجل الدخول</a>
                </p>
            </form>
        </div>
    </div>
