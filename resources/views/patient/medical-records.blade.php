...
<div class="mr-page">
    <div class="container">
        <div class="mr-header">
            <h1><i class="fas fa-file-medical text-success"></i> {{ __('messages.medical_records_title') }}</h1>
            <p class="text-muted mt-1">سجل طبيك ومراجعة تاريخك الصحي</p>
        </div>
        ...
        <div class="mr-card">
            <div class="mr-card-head">
                ...
                <a href="{{ route('patient.medical-record-detail', $record) }}" class="btn btn-primary btn-sm">
        ...
        <div class="mr-empty">
            ...
            <a href="{{ route('appointments.create') }}" class="btn btn-primary btn-lg">
                <i class="fas fa-calendar-plus"></i> {{ __('messages.book_first_appointment_now') }}
            </a>
        </div>
        @endforelse
